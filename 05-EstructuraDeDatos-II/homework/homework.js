...
LinkedList.prototype.search = function (value) {
  if (typeof value !== "function") {          // Primero me aseguro de que mi parámetro recibido NO sea una función, en ese caso, ejecuto el bloque 
                                               //para una búsqueda normal.
    ...
    if (current.value !== value) return null;   // Si logra salir del bucle sin haberse detenido voy a preguntar una vez más si el value del nodo actual es
                                                 // distinto al parámetro. En caso de que SÍ sea distinto de mi 
                                                  //parámetro, significa que salió del bucle sin encontrarlo, 
                                                  //es decir, retorno null como pide la consigna.
  
    return current.value;                       // Si no entra en el if anterior, significa que el value de mi 
                                              //nodo actual SI es igual que mi parametro, entonces retorno ese value 
                                              //de mi nodo actual.

  } else {                                      // En caso de que mi parámetro value SÍ sea una función, ejecuto 
                                                //este otro bloque...
